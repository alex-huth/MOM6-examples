#!/bin/bash
mkdir -p build/ice_oceanFMS2_SIS2_c5_nonsym_icepack_iKID/
(cd build/ice_oceanFMS2_SIS2_c5_nonsym_icepack_iKID/; rm -f path_names; \
...
(cd build/ice_oceanFMS2_SIS2_c5_nonsym_icepack_iKID/; \
...
# source ../env_c5
source build/env_c5
make NETCDF=3 REPRO=1 MOM6_SIS2_iKID -j -C build/ice_oceanFMS2_SIS2_c5_nonsym_icepack_iKID/
# cd ../..
